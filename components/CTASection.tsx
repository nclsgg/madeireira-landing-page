export default function CTASection() {
  const email = "contato@madeireira.com";
  const subject = "Orçamento - Projeto de Carpintaria";
  const body = "Olá, gostaria de solicitar um orçamento para meu projeto.\n\nDescrição do projeto:\n\n";
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
        <div className="max-w-3xl mx-auto text-center animate-on-scroll">
          <h2 className="font-playfair text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light mb-6 md:mb-8 tracking-tight leading-[1.15] px-4">
            ...
            <span className="italic">ao seu projeto?</span>
          </h2>
          
          <p className="font-inter text-base md:text-lg font-light mb-10 md:mb-12 text-white/80 leading-relaxed px-6">
            Entre em contato e descubra como podemos transformar<br />
            suas ideias em peças únicas de carpintaria.
          </p>
